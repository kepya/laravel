...
class ManageClientController extends Controller
{
    ...
    public function setting(){
        ...
        curl_setopt_array($curl, array(
        CURLOPT_URL => 'http://172.17.0.5:4000/client/auth/get/getClientByToken',
        CURLOPT_RETURNTRANSFER => true,
        CURLOPT_ENCODING => '',
        CURLOPT_MAXREDIRS => 10,
        CURLOPT_TIMEOUT => 0,
    ...
    public function invoicePaid(){
        ...
        curl_setopt_array($curl, array(
        CURLOPT_URL => 'http://172.17.0.5:4000/client/facture/getFactureWithMonth/true',
        CURLOPT_RETURNTRANSFER => true,
        CURLOPT_ENCODING => '',
        CURLOPT_MAXREDIRS => 10,
        CURLOPT_TIMEOUT => 0,
    ...
    public function budget(){
        ...
        curl_setopt_array($curl, array(
        CURLOPT_URL => 'http://172.17.0.5:4000/client/facture/factureClientWithDate',
        CURLOPT_RETURNTRANSFER => true,
        CURLOPT_ENCODING => '',
        CURLOPT_MAXREDIRS => 10,
        CURLOPT_TIMEOUT => 0,
        ...
        $response = $informations != null ? json_encode($informations['result']) : null;
        curl_close($curl);
    ...
    public function budget_detail(){
        ...
        curl_setopt_array($curl, array(
        CURLOPT_URL => 'http://172.17.0.5:4000/client/facture',
        CURLOPT_RETURNTRANSFER => true,
        CURLOPT_ENCODING => '',
        CURLOPT_MAXREDIRS => 10,
        CURLOPT_TIMEOUT => 0,
    ...
    public function invoiceUnpaid(){
        ...
        curl_setopt_array($curl, array(
        CURLOPT_URL => 'http://172.17.0.5:4000/client/facture/getFactureWithMonth/false',
        CURLOPT_RETURNTRANSFER => true,
        CURLOPT_ENCODING => '',
        CURLOPT_MAXREDIRS => 10,
        CURLOPT_TIMEOUT => 0,
    ...
    public function update(Request $request){
        ...
        if ($validator->fails()) {
            ...
            $url = "http://172.17.0.5:4000/client/auth/update";
            $alltoken = $_COOKIE['token'];
            $alltokentab = explode(';', $alltoken);
            $token = $alltokentab[0];
            $tokentab = explode('=',$token);
    ...
    public function changePassword(Request $request){
        ...
        if ($validator->fails()) {
            ...
            $url = "http://172.17.0.5:4000/client/auth/updatePassword";
            $alltoken = $_COOKIE['token'];
            $alltokentab = explode(';', $alltoken);
            $token = $alltokentab[0];
            $tokentab = explode('=',$token);
    ...
    public function paidFac(Request $request){
            ...
            $url = "http://172.17.0.5:4000/client/facture/paid/".$modalId;
            echo $url;
            $alltoken = $_COOKIE['token'];
            $alltokentab = explode(';', $alltoken);
            $token = $alltokentab[0];
